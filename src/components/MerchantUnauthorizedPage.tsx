...
const MerchantUnauthorizedPage = (props: Props) => {
  return (
    <div
      className={`flex h-screen w-full flex-col justify-center gap-10 bg-content-normal bg-[url("/images/work.png")] bg-cover bg-center bg-no-repeat px-20 py-5 text-white bg-blend-overlay items-center max-md:px-3 text-center`}
    >
      <h2
