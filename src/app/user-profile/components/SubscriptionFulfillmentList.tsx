...
import SubscriptionFulfillmentTable from '../../manage/components/SubscriptionFulfillmentTable';
import SubscriptionFulfillmentDetail from './SubscriptionFulfillmentDetail';

type Props = {
  subscriptionId: string;
  plan: subscriptionByUserItem['plan'];
  fulfillments: subscriptionByUserItem['fufillments'];
};
type Filter = {
  fulfilledOn: Date;
  paidOn: Date;
...
type Detail = {
  fulfillment: subscriptionByUserItem['fufillments'][0];
  subscriptionId: string;
  plan: subscriptionByUserItem['plan'];
  index: number;
};
const SubscriptionFulfillmentList = (props: Props) => {
  ...
  const [fulfillmentList, setFulfillmentList] = useState<
    subscriptionByUserItem['fufillments']
  >(props.fulfillments || []);
  ...
  const heading = {
    id: 'table_header',
  } as unknown as subscriptionByUserItem['fufillments'][0];
